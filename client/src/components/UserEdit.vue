		...
		<el-form ref="form" :model="form" label-width="120px" :label-position="labelPosition">
			...
			<el-col>
				<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
					<el-form-item label="Telefono Fijo">
						<el-input  v-model="usuario.tel_fijo" placeholder="xxx xxxx"/>
					</el-form-item>
				</el-col>
				<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
					<el-form-item label="Celular">
						<el-input  v-model="usuario.tel_mobil" placeholder="https://"/>
					</el-form-item>
				</el-col>
			</el-col>
			<el-col>
				<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
					<el-form-item label="Direccion">
						<el-input  v-model="usuario.direccion"/>
					</el-form-item>
				</el-col>
				<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
			...
			<el-col>
				<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
					<el-form-item label="Ciudad">
						<el-input  v-model="usuario.ciudad"/>
					</el-form-item>
				</el-col>
			</el-col>
			...
			<el-col :span="12" :md="12" :sm="24" :xs="24" class="col-p">
				<el-form-item label="Departamento">
					<el-input  v-model="usuario.departamento"/>
				</el-form-item>
			</el-col>
